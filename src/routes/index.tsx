      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Button onClick={() => handleOAuth('google')} disabled={busy} className="w-full h-11" variant="outline">
            ...
            <Button onClick={() => handleOAuth('apple')} disabled={busy} className="w-full h-11" variant="outline">
              <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M16.365 1.43c0 1.14-.42 2.22-1.19 3.02-.83.87-2.19 1.55-3.32 1.46-.14-1.12.42-2.28 1.18-3.06.85-.88 2.3-1.55 3.33-1.42zM20.5 17.29c-.56 1.3-.83 1.88-1.55 3.02-1 1.59-2.42 3.57-4.17 3.59-1.56.02-1.96-1.02-4.08-1.01-2.12.01-2.56 1.03-4.12 1.01-1.75-.02-3.09-1.81-4.09-3.4C.28 16.7-.31 11.62 1.9 8.94c1.53-1.85 3.94-2.94 6.21-2.94 2.31 0 3.76 1.27 5.67 1.27 1.85 0 2.98-1.27 5.65-1.27 2.02 0 4.16 1.1 5.68 3-4.99 2.73-4.18 9.86-4.61 8.29z"/></svg>
              Continuar com Apple
            </Button>
